...
# Pilih environment
env_name = input("Pilih environment (CartPole-v1 / MountainCar-v0): ").strip()
...
def visualize_episode():
    ...
    for time in range(500):
        ...
        done = bool(terminated) or bool(truncated)  # Gabungkan status selesai
        
        if env_name == 'MountainCar-v0':
            reward = reward if not done else 10  # Tambahan reward jika mencapai tujuan
